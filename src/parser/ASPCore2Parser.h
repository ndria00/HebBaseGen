...
public:
  ...
  ASPCore2Parser::RuleContext* rule_();
  ...
  ASPCore2Parser::Simple_ruleContext* simple_rule();
  ...
  ASPCore2Parser::Annotations_ruleContext* annotations_rule();
  ...
  ASPCore2Parser::Annotation_ruleContext* annotation_rule();
